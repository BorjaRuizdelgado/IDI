...
void MyGLWidget::modelTransform(){
        glm::mat4 TG(1.0);
        TG = glm::translate(TG,glm::vec3(vx,vy,vz));
...
void MyGLWidget::paintGL ()
{
  ...
  modelTransform(); //llamar antes de pintar para calcular la transform.
  // Pintem l'escena
...
void MyGLWidget::carregaShaders()
{
  ...
  transLoc = glGetUniformLocation(program->programId(),"TG"); //localizamos la transform.
}
